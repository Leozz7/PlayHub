...
export function usePlayHubToast() {
  ...
  const loginSuccess = (name?: string) =>
    toast.success(
        ...
        : t('toasts.loginSuccess.title'),
      {
        ...
        icon: React.createElement(ToastIcon, { icon: LogIn, color: COLORS.success }),
        duration: 3000,
      },
    );
  ...
  const loginError = (msg?: string) =>
    toast.error(t('toasts.loginError.title'), {
      ...
      icon: React.createElement(ToastIcon, { icon: ShieldAlert, color: COLORS.error }),
      duration: 4000,
    });
  ...
  const registerSuccess = () =>
    toast.success(t('toasts.registerSuccess.title'), {
      ...
      icon: React.createElement(ToastIcon, { icon: UserPlus, color: COLORS.success }),
      duration: 4000,
    });
  ...
  const registerError = (msg?: string) =>
    toast.error(t('toasts.registerError.title'), {
      ...
      icon: React.createElement(ToastIcon, { icon: XCircle, color: COLORS.error }),
      duration: 4000,
    });
  ...
  const logoutSuccess = () =>
    toast(t('toasts.logoutSuccess.title'), {
      ...
      icon: React.createElement(ToastIcon, { icon: LogOut, color: COLORS.neutral }),
      duration: 2500,
    });
  ...
  const forgotPasswordSuccess = () =>
    toast.success(t('toasts.forgotPassword.title'), {
      ...
      icon: React.createElement(ToastIcon, { icon: KeyRound, color: COLORS.success }),
      duration: 4000,
    });
  ...
  const bookingConfirmed = (courtName: string) =>
    toast.success(t('toasts.bookingConfirmed.title'), {
      ...
      icon: React.createElement(ToastIcon, { icon: CalendarCheck, color: COLORS.success }),
      duration: 5000,
    });
  ...
  const bookingCancelled = () =>
    toast(t('toasts.bookingCancelled.title'), {
      ...
      icon: React.createElement(ToastIcon, { icon: CalendarX, color: COLORS.warning }),
      duration: 3500,
    });
  ...
  const slotAlreadyTaken = () =>
    toast.warning(t('toasts.slotAlreadyTaken.title'), {
      ...
      icon: React.createElement(ToastIcon, { icon: Clock, color: COLORS.warning }),
      duration: 3500,
    });
  ...
  const reviewSuccess = () =>
    toast.success(t('toasts.reviewSuccess.title'), {
      ...
      icon: React.createElement(ToastIcon, { icon: Star, color: COLORS.success }),
      duration: 3500,
    });
  ...
  const reviewLoginRequired = () =>
    toast(t('toasts.reviewLoginRequired.title'), {
      ...
      icon: React.createElement(ToastIcon, { icon: Info, color: COLORS.info }),
      duration: 3500,
      action: {
  ...
  const contactSuccess = () =>
    toast.success(t('toasts.contactSuccess.title'), {
      ...
      icon: React.createElement(ToastIcon, { icon: Send, color: COLORS.success }),
      duration: 4000,
    });
  ...
  const success = (title: string, description?: string) =>
    toast.success(title, {
      description,
      icon: React.createElement(ToastIcon, { icon: CheckCircle2, color: COLORS.success }),
      duration: 3000,
    });
  ...
  const warning = (title: string, description?: string) =>
    toast.warning(title, {
      description,
      icon: React.createElement(ToastIcon, { icon: AlertTriangle, color: COLORS.warning }),
      duration: 4000,
    });
  ...
  const networkError = () =>
    toast.error(t('toasts.networkError.title'), {
      ...
      icon: React.createElement(ToastIcon, { icon: Wifi, color: COLORS.error }),
      duration: 5000,
    });
