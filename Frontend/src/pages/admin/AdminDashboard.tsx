        ...
        {dynamicAlerts.length > 0 && (
          <div className="space-y-2">
            {dynamicAlerts.map((alert, i) => (
              <div
                key={i}
                className={`flex items-center gap-3 px-4 py-3 rounded-xl border text-sm ${alert.type === 'warning' ? 'bg-amber-50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-800/30 text-amber-700 dark:text-amber-400' :
                  ...
                  <div key={i} className="flex items-center gap-4 px-4 py-3 hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors">
                    ...
                    <span className={`px-2.5 py-1 rounded-full text-[10px] font-black ${
                      ...
                      {u.role === 'Admin' ? t('admin.roles.admin') : 
                       u.role === 'Manager' ? t('admin.roles.manager') : 
                       t('admin.roles.athlete')}
                    </span>
