...
public static class ApplicationDbContextSeed
{
    ...
    public static async Task SeedCourtsAsync(MongoDbContext context, CancellationToken ct = default)
    {
        ...
        AddCourt(new Court("Beach Club Sport", CourtType.BeachTennis, 110, 10, "Complexo de esportes de areia"), "Avenida Giovanni Gronchi, 5930", "Morumbi", "São Paulo", "SP", null, "Café da Manhã", 4.9, 218, new List<string> { "Beach Tennis", "Vôlei de Praia" }, new List<string> { "https://images.unsplash.com/photo-1485395037613-e83d5c1f5ac4?auto=format&fit=crop&w=800&q=80" });
        ...
        AddCourt(new Court("Padel Experience", CourtType.Padel, 180, 4, "A melhor experiência de Padel"), "Avenida das Américas, 4666", "Barra da Tijuca", "Rio de Janeiro", "RJ", null, "Mais Reservado", 4.9, 276, new List<string> { "Padel", "Tênis" }, new List<string> { "https://images.unsplash.com/photo-1554068865-24cecd4e34b8?auto=format&fit=crop&w=800&q=80" });
        ...
        // New 15 Courts
        AddCourt(new Court("Arena Araci Futsal", CourtType.Futsal, 80, 10, "A melhor quadra de futsal de Araci"), "Rua Central, 10", "Centro", "Araci", "BA", 100, "Novo", 4.8, 45, new List<string> { "Futsal" }, new List<string>());
        ...
        AddCourt(new Court("Futevôlei Feira Prime", CourtType.FutVolei, 100, 4, "Areia de primeira em Feira de Santana"), "Rua da Areia, 200", "Kalilândia", "Feira de Santana", "BA", null, "Premium", 4.9, 89, new List<string> { "Futevôlei" }, new List<string>());
        ...
        AddCourt(new Court("Serrinha Futsal Arena", CourtType.Futsal, 85, 10, "Futsal de alto nível"), "Rua da Bola, 45", "Centro", "Serrinha", "BA", null, null, 4.8, 67, new List<string> { "Futsal" }, new List<string>());
        ...
        AddCourt(new Court("Araci Beach Tennis & Futevôlei", CourtType.BeachTennis, 95, 4, "Esportes de areia em Araci"), "Rua da Praia, 88", "Centro", "Araci", "BA", 130, "Verão", 4.9, 23, new List<string> { "Futevôlei", "Beach Tennis" }, new List<string>());
        ...
        AddCourt(new Court("Feira Futsal Elite", CourtType.Futsal, 110, 10, "Elite do futsal em Feira"), "Rua dos Craques, 99", "Santa Mônica", "Feira de Santana", "BA", 150, "Top 1", 5.0, 120, new List<string> { "Futsal" }, new List<string>());
        AddCourt(new Court("Teofilândia Futevôlei Arena", CourtType.FutVolei, 80, 4, "Sinta a areia de Teofilândia"), "Av. das Palmeiras, 10", "Centro", "Teofilândia", "BA", null, null, 4.6, 15, new List<string> { "Futevôlei" }, new List<string>());
        ...
        AddCourt(new Court("Feira Sport Mix", CourtType.Futsal, 120, 20, "Multiesportiva em Feira"), "Rua do Mix, 123", "Cidade Nova", "Feira de Santana", "BA", null, "Completa", 4.8, 54, new List<string> { "Futsal", "Basquete", "Vôlei" }, new List<string>());
